                ...
                <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-[1000] w-full">
                    ...
                    >
                        ...
                        <div className='relative h-[60%] w-full'>
                            <Image width={300} height={300} className="w-full object-contain" src="/images/mark-okechukwu.jpeg" alt="Mark Image" />
                        ...
                        <p className='my-5 flex flex-col items-center'>
                            ...
                            <a
                                ...
                                className="bg-green-500 gap-x-1 flex items-center text-white px-3 py-1 rounded-md hover:bg-green-600 transition duration-300 mt-4"
                            >
